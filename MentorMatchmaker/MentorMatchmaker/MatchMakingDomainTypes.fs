...
let designingWithTypes = { Category = DesigningWithTypes; PopularityWeight = PopularityWeight.Rare }
let metaProgramming = { Category = MetaProgramming; PopularityWeight = PopularityWeight.Rare }